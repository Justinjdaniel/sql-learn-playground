...
require(['vs/editor/editor.main'], function() {
    ...
    monaco.languages.registerCompletionItemProvider('sql', {
        provideCompletionItems: function(model, position) {
            const suggestions = [];
            // Add SQL keywords
            const keywords = ['SELECT', 'FROM', 'WHERE', 'JOIN', 'ON', 'GROUP BY', 'ORDER BY', 'LIMIT', 'INSERT INTO', 'VALUES', 'UPDATE', 'SET', 'DELETE'];
            ...
            // Add column names
            Object.values(tableSchemas).flat().forEach(columnName => {
                suggestions.push({
                    label: columnName,
